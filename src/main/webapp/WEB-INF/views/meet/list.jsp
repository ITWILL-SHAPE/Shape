...
<body>
                  ...
                  <a href="${ meetDetailPage }" class="text-decoration-none"
                     ...
                     <div class="col">
                        <div class="card shadow-sm image-container position-relative">
                           ...
                           <form id="heartSelect${status.begin}">
                              <button class="btn" id="btnToggleReply${status.begin}"
                                 data-toggle="toggle-off">
                                 <img id="toggleBtnIcon${status.begin}"
                                    src="../static/images/sample/like2.svg" alt="toggle-off"
                                    width="50" class="overlay-image overlay-right" />
                              </button>
                           </form>

                           </form>
                           <div id="recruiSelect${status.begin}">
                              <img id="recruiImg${status.begin}"
                              ...
                              <div class="post-inner">
                                 ...
                                 <div class="row align-items-center">
                                    ...
                                    <div class="col text-lg-end text-center">
                                       ...
                                       <span class="text-end" id="post-lcnt${status.begin}">
                                          <em>${cardList.lcnt}</em>
                                       </span>
                                    </div>
                                 </div>
                                 <div id="post-sidoAndTitle${status.begin}">[ ${ cardList.sido }
                                    ] < ${ cardList.title } ></div>
   ...
   <script src="../static/js/meet-list.js"></script>
</body>
