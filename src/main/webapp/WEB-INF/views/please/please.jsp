	...
	<body>
				...
				<tbody id="userList">
					<c:forEach items="${ list }" var="file" varStatus="state">
						<tr>
							<td>${ file.idx }</td>
							<td>
								<a href="#this" name="file" data-id="${ file.idx }">
									${ file.fileName }
								</a>
							</td>
							<td>
								...
								<img src="${ url }" style="max-width: 50%; min-height: 50px;" />
							</td>
							<td>
								<button type="button" onclick="deleteRow(this);"
									data-id="${ file.idx }">X</button>
							</td>
							<td>
								<button type="button" onclick="download(this);"
									data-id="${ file.idx }">다운로드</button>
							</td>
						</tr>
					</c:forEach>
				</tbody>
		...
		<script type="text/javascript">
	        ...
	        function deleteRow(e) {
	        	let idx = e.getAttribute('data-id');
	        	console.log(idx);
	        	
	        	axios.post('/shape/please/delete/' + idx)
	        	.then((res) => {
	        		console.log(res);
	        		window.location.href = '/shape/please/please';
	        	})
	        	.catch((err) => {
	        		console.log(err);
	        	})
