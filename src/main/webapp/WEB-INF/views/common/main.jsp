...
<p>
	header랑 footer를 적용하고 싶으시면<br> main.jsp와 같이 만들어주세요.<br>
	include header, footer를 하고 안에 body를 써주세요.<br> content는 body안에서
	써주시면 됩니다.<br> 또 js와 css를 추가하고 싶으시면 header에 있는 head 부분에 써주시면 됩니다.<br>
	admin은 사이드 바이기 때문에 또 다릅니다.<br> admin css를 고칠 때까지 기다려주세요.<br>
