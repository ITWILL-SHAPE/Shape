...
<body>
    ...
    -->
					<c:forEach items="${ activeList }" var="activeList" varStatus="status">
						<c:url var="meetDetailPage" value="/meet/maindetail">
							<c:param name="mtid"
								     value="${activeList.mtid}" />
						</c:url>
						<div class="col"
							...
							<div class="card shadow-sm image-container position-relative">
								<svg idx="${status.begin}"
									 ...
									 width="100%" height="220" role="img" focusable="false">
              				<rect width="100%" height="100%" fill="#55595c" />
								...
								<sec:authorize access="isAuthenticated()">
									<button id="logInUser">
										<img src="./static/images/sample/like2.svg"
											 ...
											 width="50" alt="toggle-off" onclick="alert(확인)" />
									</button>
								</sec:authorize>
								<!-- 로그인 안 함 -->
								...
								<div class="card-body">
											...
											<div class="col text-lg-end text-center">
                     						 ...
                     						 <path d="M4 1c2.21 0 4 1.755 4 3.92C8 2.755 9.79 1 12 1s4 1.755 4 3.92c0 3.263-3.234 4.414-7.608 9.608a.513.513 0 0 1-.784 0C3.234 9.334 0 8.183 0 4.92 0 2.755 1.79 1 4 1z" />
												...
												<span class="text-end" id="heart${status.begin}">
													<em>${activeList.LCNT}</em>
												</span>
											</div>
										</div>
										<div id="post-sidoAndTitle${status.begin}">
										[${activeList.sido} ] &lt;${activeList.title}&gt;
										</div>
									...
									<div class="text-lg-end text-center">
										<small class="text-muted"> 모집인원: 
										<span id="currentApplicants${status.begin}">${activeList.PCNT}</span>
