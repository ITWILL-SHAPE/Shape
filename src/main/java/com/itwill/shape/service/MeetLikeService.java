...
public class MeetLikeService {
	...
	/*
	 * // 찜 등록 public int likeInsert(long mtid, String id) {
	 * log.info("likeinsert(mtid={}, id={})", mtid, id);
	 * 
	 * return meetLikeRepository.likeCreate(mtid, id); }
	 * 
	 * // 찜 삭제 public int likeDelete(long mtid, String id) {
	 ...
	 * log.info("getLikeCountByMtid(mtid={})", mtid); return
	 * meetLikeRepository.getLikeCountByMtid(mtid); }
	 * 
	 * public int getCountByMtid(int mtid) { log.info("getCountByMtid(mtid={})",
	 * mtid); return meetLikeRepository.getCountByMtid(mtid); }
	 * 
	 * public boolean isLikedByUser(int mtid, String id) {
	 * log.info("isLikedByUser(mtid={}, id={})", mtid, id); return
	 * meetLikeRepository.isLikedByUser(mtid, id); }
	 * 
