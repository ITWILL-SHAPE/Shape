...
//	private String an_title이 있으면 답변완료, 없으면 확인중
	...
	public static InfoQnAListDto fromEntity(InfoQnA entity) {
		return InfoQnAListDto.builder().qid(entity.getQid()).title(entity.getTitle())
				.created_date(Timestamp.valueOf(entity.getCreated_date())).secret(entity.getSecret())
				.an_title(entity.getAn_title()).writer(entity.getWriter()).build();
	}
}
